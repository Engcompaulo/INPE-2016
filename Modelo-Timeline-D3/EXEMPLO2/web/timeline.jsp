...
<%-- 
    Document   : timeline
    Created on : Nov 1, 2016, 2:26:03 PM
    Author     : rafael
--%>

<%@page import="utils.Teste"%>
  ...
  <body>
         ...
         d3.timeline = function() {
            ...
            var hover = function () {},
                ...
                tickFormat = { format: d3.time.format("%Y %b"), //"%Y %b" %Y-%m-%d
            ...
            function timeline (gParent) {
              ...
              var xScale = d3.time.scale()
                .domain([<%=Teste.obterDataInicial() %>, <%=Teste.obterDataFinal() %>])
...
//                                                  label: "person a", 
//                                                  times: [
//                                                            {"color":"green", "label":"A", "starting_time": 1262304000, "ending_time": 1267401600}, 
//                                                            {"color":"red", "label":"", "starting_time": 1267401600, "ending_time": 1271289600}
//                                                  ]
//                                        },
                                            ...
                                            
                                        {
                                                  label: "person c", 
                                                  times: [
                                                            {"color":"green", "label":"", "starting_time": new Date(2010, 6-1, 1), "ending_time": new Date(2010, 8-1, 1)}
                                                  ]
                                        }
                              ];
                    ...
                    function timelineLabelColor() {
                              ...
                              .beginning(<%=Teste.obterDataInicial() %>) // we can optionally add beginning and ending times to speed up rendering a little
                              .ending(<%=Teste.obterDataFinal() %>)
