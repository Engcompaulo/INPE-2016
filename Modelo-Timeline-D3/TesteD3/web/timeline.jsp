  ...
  <body>
      ...
      <script>
         d3.timeline = function() {
            ...
            var hover = function () {},
                ...
                tickFormat = { format: d3.time.format("%Y %b"),
            ...
            function timeline (gParent) {
              ...
              var xScale = d3.time.scale()
                .domain([new Date(2010, 0, 0), new Date(2017, 0, 0)])
    ...
    return timeline;
                              ...
                              var labelColorTestData = [
                                        {
                                                  label: "person a", 
                                                  times: [
                                                            {"color":"green", "label":"A", "starting_time": 1263081600, "ending_time": 1299715200}, 
                                                            {"color":"blue", "label":"D", "starting_time": 1280620800, "ending_time": 1283299200}
                                                  ]
                                        },
                                        {
                                                  label: "person b", 
                                                  times: [
                                                            {"color":"pink", "label":"B", "starting_time": 1264982400, "ending_time": 1277942400}
                                                  ]
                                        },
                                        {
                                                  label: "person c", 
                                                  times: [
                                                            {"color":"yellow", "label":"C", "starting_time": 1264982400, "ending_time": 1277942400}
                                                  ]
                                        }
                              ];
                  ...
                  var chart = d3.timeline()
                    .beginning(1262304000) // we can optionally add beginning and ending times to speed up rendering a little
                    .ending(1451606400)
